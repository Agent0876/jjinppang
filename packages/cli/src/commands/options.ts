...
export const initParseArgsConfig = {
  ...
  'skip-install': { type: 'boolean' as const },
  skipInstall: { type: 'boolean' as const },
  'skip-pods': { type: 'boolean' as const },
  skipPods: { type: 'boolean' as const },
  template: { type: 'string' as const },
  oxc: { type: 'string' as const },
  redux: { type: 'boolean' as const },
  webview: { type: 'boolean' as const },
  monorepo: { type: 'boolean' as const },
  next: { type: 'boolean' as const },
  nextjs: { type: 'boolean' as const },
